...
// node_modules/fetch-opengraph/index.js
var require_fetch_opengraph = __commonJS({
  "node_modules/fetch-opengraph/index.js"(exports) {
    "use strict";
    ...
    var fetchRaw = (url, headers) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    var fetch = (url, headers, includeRaw = false) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        try {
          ...
          result[twitterImage] = result[twitterImage] ? result[twitterImage] : result[ogImage];
          ...
          result[twitterUrl] = result[twitterUrl] ? result[twitterUrl] : result[ogUrl];
          result.url = url;
          result[ogDescription] = result[ogDescription] ? result[ogDescription] : result.description;
          result[twitterDescription] = result[twitterDescription] ? result[twitterDescription] : result[ogDescription];
          result.description = result[ogDescription];
          result[ogTitle] = result[ogTitle] ? result[ogTitle] : siteTitle;
          result[twitterTitle] = result[twitterTitle] ? result[twitterTitle] : result[ogTitle];
...
// dep:fetch-opengraph
var fetch_opengraph_default = require_fetch_opengraph();
export {
  fetch_opengraph_default as default
};
//# sourceMappingURL=fetch-opengraph.js.map
